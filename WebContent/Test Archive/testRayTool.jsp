...
<body>
	...
	<script>
		...
		var toolMaterial = new THREE.MeshPhongMaterial( { map: toolTexture } );
		...
		for (xCoord = 0; xCoord <= 5; xCoord += elemSize){
			for (zCoord = 0; zCoord <= 5; zCoord += elemSize){
				var billetGeometry = new THREE.BoxGeometry( elemSize, 5, elemSize );
